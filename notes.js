...
{
    let messagesuccess1 = document.getElementById('messagesuccess1');
    messagesuccess1.innerHTML = `<div class="alert alert-success" role="alert">
            ${num}  Notes added Successfully <a href="https://jun2001r.github.io/notes/mynotes.html"style="color:#1a3821">Go to notes</a>
                        </div>`;
    let gonotes = document.getElementById('gonotes');
    gonotes.innerHTML = `<i> ${num} </i>`;
}
